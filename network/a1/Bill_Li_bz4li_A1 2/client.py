...
# Send negotiation request to the server
...
# Handle PUT command to send file to server
...
# Handl GET command to receive file from server
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        ...
        print(f"INFO: python3 client.py <server_address> <n_port> <command> <filename>")
        sys.exit(1)
